...
- 分周比が奇数のときはduty比が50%より若干大きくなります．50%にしたら5.4MHzで動かなくなったので，50%にするためのコードはコメントアウトしてます．
- IM6100AはVcc=10Vで8MHzというスペックのようですが，5Vでも5.4MHzであれば動く感じでした．個体によっては6.75MHzで動作するものもありましたが、動かないものもあったので，余裕をみて4.5MHzにしています．
